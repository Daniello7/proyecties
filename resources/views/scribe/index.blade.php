...
<div class="bash-example">
    ...
    "http://proyecties.test/api/register" \
    --header "Content-Type: application/json" \
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Your username. Example: <code>Test User</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>email</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email. Example: <code>test@mail.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Password. Example: <code>123</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://proyecties.test/api/login" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"email\": \"test@mail.com\",
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://proyecties.test/api/logout" \
    --header "Authorization: Bearer YOUR_AUTH_KEY" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
