...
<head>
    ...
    <title>Normas Transportistas</title>
</head>
<style>
    h3 {
...
<div class="container">
    <header id="header">
        <p id="rules-name">NORMAS TRANSPORTISTAS</p>
    ...
    <p><b>El incumplimiento de estas normas puede resultar en la negación del acceso a las instalaciones.</b></p>
    <hr>
