<div class="flex flex-row gap-4 mb-2">
    {{-- Person Info --}}
    <fieldset class="flex-1 border p-2 rounded-lg">
    ...
    {{-- Form Fields --}}
    <fieldset class="flex-[3] flex flex-row justify-evenly gap-2 rounded">
        <div>
            ...
            <div class="mt-4">
                <input id="notify" name="notify" type="checkbox" class="cursor-pointer rounded hover:ring-2 dark:checked:bg-blue-600 dark:bg-transparent dark:border-white"/>
