<x-home-layout>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="text-gray-800 dark:text-gray-100 bg-white dark:bg-gray-800 rounded-lg p-2 shadow-lg transition-colors duration-500">
                <h2 class="text-xl font-semibold p-4 custom-gradient-text">
                    {{ strtoupper(__('New Entry')) }}
                </h2>
